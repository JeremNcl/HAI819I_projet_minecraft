...
class TerrainGenerator{
    public:
        ...
        std::vector<BlockType>GenerateChunk(int Chunk_x, int Chunk_y);
        
    private:
        int m_seed;
        TerrainConfig m_config;
        void GenerateTree(int startX, int startY, int startZ, std::vector<BlockType>& blocks) const;
        void GenerateMineralVein(BlockType mineral, int startX, int startY, int startZ, int maxBlock, std::vector<BlockType> &block) const;
